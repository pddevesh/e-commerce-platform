...
public class Manager {
	...
	public ItemVO getItemDetail(String name) throws Exception {
		...
		String str100="Item Received";
		//String sql2="select count(itemid) from transactions where itemid in(select itemid from selleritem where sellerid="+sid+")";
		String sql2="select count(itemid) from transactions where status ='"+str100+"' and itemid in(select t.itemid from selleritem si,transactions t where si.itemid = t.itemid and sellerid="+sid+" and status='"+str100+"')";
