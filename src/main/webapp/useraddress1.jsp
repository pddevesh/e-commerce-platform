...
console.log("Final Status");
      // var u ="http://localhost:8080/akshay/FinalStatus.jsp?pids="+'<%= pid%>'+ "&addresscode="+addressCode;
      var u="http://localhost:8080/akshay/NewFile.jsp";
      alert("Success");
	 console.log(u);
...
function myFunction() {
	 ...
	 console.log("Select New Address");
	  window.location.href ="http://localhost:8080/akshay/AddressFormPage.jsp";
