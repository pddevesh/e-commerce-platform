...
//out.print(pid);
dealamount=request.getParameter("dealamount");
name =(String)session.getAttribute("name");
qty=(Integer)session.getAttribute("dealsqty");
             ...
             { 
            	...
            	// uri+=qu;
            	 ...
            	 $.ajax({
            	  ...
            	  window.location="Dealpaymentsuccess.jsp?dealspid=<%=dealspid%>";
             console.log(data);
             }
             else
            	 {
            	 window.location="Dealaymentfail.jsp?dealspid=<%=dealspid%>";
                 console.log(data);
            	 }
         },
         error: function (data) {
