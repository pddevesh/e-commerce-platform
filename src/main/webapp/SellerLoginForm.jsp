...
<form action="SellerLogin.jsp" method="get">
  ...
  vertical-align: top;" ></span>
					...
					<div class= "a-section auth-pagelet-container">
						<form id= "ap_register_form" name= "register" method= "post" style="display: block; margin-top: 0em" class="ap_ango_default auth-validate-form-moa auth-real-time-validation fwcim-form">
							...
							<div class="a-box-inner">
								<h1 style="margin-bottom: 10px!important; font-weight: 400; font-size: 28px; line-height: 1.2;">Seller Login</h1>
								<div class="a-row a-spacing-base">
									<label for="ap_email" class="a-form-label">Email</label>
									<input type="email" maxlength="128" id="ap_email" name="username" tabindex="1" class="a-input-text a-span12 auth-autofocus auth-required-field">
    ...
    vertical-align: middle;">
							...
							<div class="a-row">
										Need Help?
										<a class="link" href="http://localhost:8080/akshay/SellerRegistration.jsp">Sign in</a>
									</div>
							</div>		
						</form>
					</div>
