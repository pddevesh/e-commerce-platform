...
<!--  <form action="webapi/webservice/addSeller" method="post"> -->
<form id="sellersignup">
					...
					<div class= "a-section auth-pagelet-container">
						<form id= "ap_register_form" name= "register" method= "post" style="display: block; margin-top: 0em" class="ap_ango_default auth-validate-form-moa auth-real-time-validation fwcim-form">
							...
							<div class="a-box-inner">
								<h1 style="margin-bottom: 10px!important; font-weight: 400; font-size: 28px; line-height: 1.2;">Create Account</h1>
								
								<label for= "sellername" class="a-form-label" style=" width: 100%!important;" >Your Name</label>
								<input type="text" id="sellername" name="sellername" maxlength="20" tabindex="1" style="width: 100%!important; " required><br><br>
								
								<label for= "al1" class="a-form-label" style=" width: 100%!important;" >Address Line1</label>
								<input type="text" id="al1" name="al1" tabindex="1" style="width: 100%!important; " required><br><br>
								
								<label for= "al2" class="a-form-label" style=" width: 100%!important;" >Address Line2</label>
								<input type="text" id="al2" name="al2" tabindex="1" style="width: 100%!important; " required><br><br>
								
								<label for= "city" class="a-form-label">City</label>
								<input type="text" name="city" id="city" style="width: 100%!important;" required><br><br>
								
								<label for= "state" class="a-form-label">State</label>
								<input type="text" name="state" id="state" style="width: 100%!important;" required><br><br>
								
								<label for= "pincode" class="a-form-label">Pincode</label>
								<input type="text" name="pincode" id="pincode" style="width: 100%!important;" required><br><br>
								
								<label for= "mobnumber" class="a-form-label">Mobile Number</label>
								<input type="text" name="mobnumber" pattern="^\d{10}$" maxlength="10" id="mobnumber" style="width: 100%!important;" required><br><br>
								
								<label for= "emailid" class="a-form-label">Email Address</label>
								<input type="email" name="emailid" id="emailid" style="width: 100%!important;" required><br><br>
								
								<label for= "password" class="a-form-label" >Password</label>
								<input type="password" name="password" id="password" placeholder="At least 6 characters" tabindex="8" min="6" style="width: 100%!important; " required ><br><br>
								<br>
								<div class="a-box-inner">
								<span id=""><!-- will be used for modal-->
								<span class="button" style="  width: 100%!important;   background: #f0c14b;
									...
									<span id="auth-continue-announce" class="a-button-text" >Register </span>
								</span>
								</span>
								<br>							
								<div>
												Already have an account?
										<a href="SellerLoginForm.jsp">Sign in</a>
									</div>
							</div>
							</div>		
						</form>
...
<script type="text/javascript">
    ...
    frm.submit(function (e) {
        ...
        $.ajax({
            type: 'post',
            dataType: 'text',
            url: 'webapi/webservice/addSeller',
            contentType: 'application/x-www-form-urlencoded',
            data: frm.serialize(),
            success: function (data) {
                console.log('Submission was successful.');
                alert("success");
                window.location.replace("SellerLoginForm.jsp");
                console.log(data);
            },
            error: function (data) {
