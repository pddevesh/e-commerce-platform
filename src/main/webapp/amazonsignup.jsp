...
<!--  <form id="signup" action="webapi/webservice/addUser" method="post"> -->
<form id="signup">
  ...
  vertical-align: top;" ></span>
						...
						<form id= "ap_register_form" name= "register" method= "post" style="display: block; margin-top: 0em" class="ap_ango_default auth-validate-form-moa auth-real-time-validation fwcim-form">
							...
							<div class="a-box-inner">
								...
								<div class="a-row a-spacing-base">
									<label for= "username" class="a-form-label" style=" width: 100%!important;" >Your Name</label>
									<input type="text" id="username" name="username" maxlength="20" tabindex="1" style="width: 100%!important; " required><br><br>
								</div>
								...
								<label for= "emailid" class="a-form-label">Email Address</label>
									<input type="email" name="emailid" id="emailid" style="width: 100%!important;" ><br><br>
								...
								<span class="button" style="  width: 100%!important;   background: #f0c14b;
									...
									<span id="auth-continue-announce" class="a-button-text" >Continue </span>
    ...
    vertical-align: middle;">
									...
									<input id="upload image" tabindex="5" class="a-button-input"  aria-labelledby="continue-announce" onclick="window.location.href='http://localhost:8080/akshay/UserImage.html'"><span id="continue-announce" class="a-button-text" aria-hidden="true">Upload Image </span>
								</span>
									</span>
									...
									<div class="a-row">
										...
										<a class="link" href="amazonlogin.jsp">Sign in</a>
									</div>
							</div>
							</div>		
						</form>
